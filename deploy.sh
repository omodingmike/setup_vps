...
echo "########################################################"
echo "#                                                      #"
echo "#   ⚠️  ACTION REQUIRED — READ CAREFULLY BEFORE        #"
echo "#      PRESSING ENTER                                  #"
echo "#                                                      #"
echo "########################################################"
echo ""
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo " PART 3 OF 3 — CI/CD PRIVATE KEY → GitHub Actions Secret"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo " PURPOSE: GitHub Actions uses this private key to SSH into this"
echo "          server and trigger deployments automatically."
echo ""
echo " WHERE:   GitHub → Your Repo → Settings → Secrets and variables"
echo "                 → Actions → New repository secret"
echo " Name:    SSH_PRIVATE_KEY"
echo " Value:   Copy everything below (include the BEGIN and END lines)"
echo ""
...
read -p "Press [Enter] ONLY AFTER you have completed all 3 parts above..."
